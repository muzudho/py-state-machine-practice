...
INPUT_TRANSITION_JSON_FILE_PATH = "lesson19_data/auto_gen/pen-transition.json"
OUTPUT_AUTO_TRANSITION_FILE_PATH = "lesson21_data/auto_gen/step2_pen_transition.py"
