...
class Main:
    def on_main(self):
        ...
        FileIo.makedirs(os.path.dirname(OUTPUT_CONST_JSON_FILE_PATH))
        print(f"[L20] write {OUTPUT_CONST_JSON_FILE_PATH}")
        FileIo.write(OUTPUT_CONST_JSON_FILE_PATH, out_text)
        ...
        # gen_const_file_v17(OUTPUT_CONST_PY_FILE_PATH, house3_const_py_dict)
