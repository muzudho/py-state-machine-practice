import os
from lesson16n2.transition_conf_v1n1 import TransitionConfV1n1
...
class Render:
    ...
    def run(self):
        transition_conf = TransitionConfV1n1(transition_conf_data)
        ...
        # ノードの一覧
        node_path_set = TransitionConfV1n1.extract_node_path_set(edge_list)
